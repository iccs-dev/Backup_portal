...
DB_PATH="/home/iccsadmin/ishita/Disposition_Uploads/db.sqlite3"
BACKUP_DIR="/home/iccsadmin/Backup_Portal/media/Disposition_Uploads"

# Ensure backup directory exists
mkdir -p "$BACKUP_DIR"

# File names (always overwrite)
UPLOADED_FILES_CSV="${BACKUP_DIR}/disp_uploaded_files.csv"
USERS_CSV="${BACKUP_DIR}/disp_users.csv"
